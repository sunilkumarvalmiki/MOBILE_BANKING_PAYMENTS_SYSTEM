...
public partial class saving : System.Web.UI.MobileControls.MobilePage
{
    SqlConnection con;
    SqlCommand com;
    //SqlDataAdapter da;
    ...
    public void from()
    {
        ...
        frm = "withdraw";
        con.Open();
        com = new SqlCommand("sp_ins4", con);
    ...
    public void fun()
    {
        ...
        con.Close();
        con.Open();
        com = new SqlCommand("select balance from tblsavmain where accountid='" + TextBox1.Text + "'", con);
        ...
        con.Close();
        con.Open();
        com = new SqlCommand("select balance from tblsavmain where accountid='" + TextBox3.Text + "'", con);
        dr = com.ExecuteReader();
        while (dr.Read())
        {
            p = dr[0].ToString();
    ...
    public void check()
    {
        con.Close();
        con.Open();
        com = new SqlCommand("select *  from tblsavmain where accountid = '"+TextBox3.Text.ToString()+"'", con);
        dr = com.ExecuteReader();
        if (dr.Read())
        {
    ...
    public void ch()
    {
        ...
        con.Close();
        con.Open();
        com = new SqlCommand("select accountid,pwd  from tblsavmain where accountid='" + TextBox1.Text.ToString() + "'and pwd = '"+TextBox4.Text+"'", con);
        dr = com.ExecuteReader();
        if (dr.Read())
        {
    ...
    public void bal()
    {
        ...
        con.Close();
        con.Open();
        com = new SqlCommand("select balance from tblsavmain where accountid='" + TextBox1.Text.ToString() + "'", con);
        dr = com.ExecuteReader();
        if (dr.Read())
        {
            ...
            else
            {
                check();
             Label6.Visible = true;
            Label6.Text = "your transaction  made succsesfully ";
