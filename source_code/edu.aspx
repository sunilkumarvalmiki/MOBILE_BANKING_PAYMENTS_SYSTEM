...
<body>
    <mobile:Form id="Form1" runat="server" BackColor="#ccffcc"><mobile:Label ID="Label1" Runat="server" Alignment="Center" Font-Bold="True" Font-Size="Large"
        ...
        <mobile:RequiredFieldValidator ID="RequiredFieldValidator1" Runat="server" Alignment="Center"
            ControlToValidate="TextBox1" ErrorMessage="empty value not allowed">
        ...
        <mobile:SelectionList ID="SelectionList1" Runat="server" Alignment="Center">
            ...
            <Item Text="18" Value="18" />
            <Item Text="24" Value="24" />
        ...
        <br />
        <mobile:Link ID="Link1" Runat="server" Alignment="Center" Font-Bold="True" ForeColor="DodgerBlue"
            NavigateUrl="~/loan.aspx">Back</mobile:Link>
